...
RooWorkspace *FitLb2NstG_Simult(string *variablename, TTree **tree, string opts)
{
     ...
     //This width can be shrunk or amplified
     value = ws_ppiG_mass[0]->var(name_list.width[0].c_str())->getValV();
     if (const_list.widthshift1 != 0.)
     {
          value = value + const_list.widthshift1 * stod(GetErrorFor("#sigma_{K#pi#gamma}", "output/B_M012_RooYields_WrongMassFit.txt"));
     }
     ...
     if (const_list.widthshift2 != 0.)
     {
          value = value + const_list.widthshift2 * stod(GetErrorFor("#sigma_{pK#gamma}", "output/B_M012_Subst01_Kpi2pK_RooYields_WrongMassFit.txt"));
     }
