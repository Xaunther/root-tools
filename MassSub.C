...
void MassSub_pKG_Gauss (string dirfile, string outfile = "");
...
void MassSub(string dirfile, string outfile, string deccode)
{
  ...
  else if (deccode == "pKG_Gauss") {MassSub_pKG_Gauss(dirfile, outfile);}
...
/*********************************************************************************************************************************************************/
//Used to deal with generator level Lb->pKG MC
void MassSub_pKG_Gauss(string dirfile, string outfile)
{
  //Data chain
  TChain* inchain = GetChain(dirfile);
